...
describe("BinarySearchTree", function () {
    ...
    describe("min() method when the tree is empty", function () {
        let bst = new BinarySearchTree();
        it("returns the Null when there is no element in the bst", function () {
    ...
    describe("min() method", function () {
        it(" returns an array containing all the values currently in the BST ", function () {
            
            let myarray=[12,34,11,45,66];
            bst.insertAll(myarray);
            bst.readIntoArray();
